...
import TitleQuote from "../cotizador/titleQuote";
import QontoConnector from "../cotizador/quontoConnector";
...
function HomeQuoteStepOne({ activeStep, setActiveStep,
  setHomeQuoterData, homeQuoterData,steps}: Props) {
  ...
  return (
    <Box sx={{
        borderRadius:'20px', 
        boxShadow:'0px 4px 40px rgba(21,31,109,0.15)',
        width: '567px',
        height: '535px'}}>
...
export default HomeQuoteStepOne;